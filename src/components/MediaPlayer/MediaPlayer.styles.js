...
export const MediaPlayerSkeleton = styled.div`
...
export const PrevButton = styled(PlayerButton)`
  margin-right: 23px;
`;
...
export const NextButton = styled(PlayerButton)`
  margin-right: 28px;
  fill: #a53939;
...
export const RepeatButton = styled(PlayerButton)`
  margin-right: 24px;
...
export const ShuffleButton = styled(PlayerButton)`
  display: flex;
  align-items: center;
